...
usleep(mt_rand(25000, 100000) * 10);
...
$fieldlist = array('firstname','lastname','phone'); 

// initialize data file
if (!file_exists($datafile)) {
	savedata(
		array(
			array("firstname" => "John","lastname" => "Doe","phone" => "000-000-0001"),
			array("firstname" => "Alex","lastname" => "Jones","phone" => "000-000-0002"),
			array("firstname" => "Mary","lastname" => "Allen","phone" => "000-000-0003"),
			array("firstname" => "Peter","lastname" => "Geraci","phone" => "000-000-0004"),
			array("firstname" => "Liz","lastname" => "Cleaver","phone" => "000-000-0005"),
			array("firstname" => "Harry","lastname" => "Jacobs","phone" => "000-000-0006"),
			array("firstname" => "Alice","lastname" => "Hartmann","phone" => "000-000-0007"),
			array("firstname" => "Maria","lastname" => "Alvarez","phone" => "000-000-0008"),
			array("firstname" => "June","lastname" => "Wendell","phone" => "000-000-0009"),
			array("firstname" => "Bob","lastname" => "Tackle","phone" => "000-000-0010"),
			array("firstname" => "Jane","lastname" => "Smith","phone" => "000-000-0011")
		), 
		$datafile);
}
