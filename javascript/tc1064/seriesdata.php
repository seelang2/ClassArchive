	...
	case 'EDIT':
		...
		foreach ($data as $fdata) {
			foreach ($fdata as $subset) {
				foreach ($subset as $item) {	
					if ($item == $xitem) {
						$_SESSION['data'][$fdata][$subset][$item]['Name'] = $_GET['Name'];
						$_SESSION['data'][$fdata][$subset][$item]['Size'] = $_GET['Size'];
						$_SESSION['data'][$fdata][$subset][$item]['Color'] = $_GET['Color'];
						$_SESSION['data'][$fdata][$subset][$item]['Type'] = $_GET['Type'];
						$_SESSION['data'][$fdata][$subset][$item]['Price'] = $_GET['Price'];
