<?php
/*******
 * userdata.php - simple back-end data service 
 * v.1.0 Chris Langtiw chris@sitebabble.com www.sitebabble.com
 * Creative Commons License CC BY http://creativecommons.org/licenses/by/3.0/
 *
