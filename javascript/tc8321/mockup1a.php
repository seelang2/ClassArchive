...
$(document).ready(function() {
	/*
	  if you HAVE to attach the same handler to multiple elements
	  do NOT use an anonymous function, which gets copied multiple
	  times and bloats memory. Instead use a named function.
	*/
