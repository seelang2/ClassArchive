...
//			alert('Event type: ' + e.type);
		...
		temp1.ondblclick = function() { editInPlace(this); }
...
function editInPlace(targetElem) {

//	alert('Target element: ' + targetElem.id);

//	targetElem.childNodes[0].firstChild.nodeValue

	td1 = targetElem.childNodes[0];
	tdtext1 = targetElem.childNodes[0].firstChild.nodeValue;

	td1.removeChild(td1.firstChild);
	temp1 = document.createElement('INPUT');
	td1.appendChild(temp1);
	temp1.setAttribute("NAME", pageData.productFields[0]);
	temp1.setAttribute("ID", pageData.productFields[0]);
	temp1.setAttribute("VALUE", tdtext1);


	td2 = targetElem.childNodes[1];
	tdtext2 = targetElem.childNodes[1].firstChild.nodeValue;

	td2.removeChild(td2.firstChild);
	temp1 = document.createElement('INPUT');
	td2.appendChild(temp1);
	temp1.setAttribute("NAME", pageData.productFields[1]);
	temp1.setAttribute("ID", pageData.productFields[1]);
	temp1.setAttribute("VALUE", tdtext2);


	td3 = targetElem.childNodes[2];
	tdtext3 = targetElem.childNodes[2].firstChild.nodeValue;

	td3.removeChild(td3.firstChild);
	temp1 = document.createElement('INPUT');
	td3.appendChild(temp1);
	temp1.setAttribute("NAME", pageData.productFields[2]);
	temp1.setAttribute("ID", pageData.productFields[2]);
	temp1.setAttribute("VALUE", tdtext3);


	td4 = targetElem.childNodes[3];
	tdtext4 = targetElem.childNodes[3].firstChild.nodeValue;

	td4.removeChild(td4.firstChild);
	temp1 = document.createElement('INPUT');
	td4.appendChild(temp1);
	temp1.setAttribute("NAME", pageData.productFields[3]);
	temp1.setAttribute("ID", pageData.productFields[3]);
	temp1.setAttribute("VALUE", tdtext4);


	td5 = targetElem.childNodes[4];
	tdtext5 = targetElem.childNodes[4].firstChild.nodeValue;

	td5.removeChild(td5.firstChild);
	temp1 = document.createElement('INPUT');
	td5.appendChild(temp1);
	temp1.setAttribute("NAME", pageData.productFields[4]);
	temp1.setAttribute("ID", pageData.productFields[4]);
	temp1.setAttribute("VALUE", tdtext5);
