...
if(!isset($classes[$class])) {
	exit('Invalid class specified');
}

//$class = '2000';
$target_donors = $classes[$class]['targetdonors'];
$current_donors = $classes[$class]['currentdonors'];
$target_amount = $classes[$class]['targetamount'];
$current_amount = $classes[$class]['currentamount'];
