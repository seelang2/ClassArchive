...
$graph_width = 350; // desired width of thermometers in pixels
...
.vbar {
	float: left;
	width: <?php echo ($graph_width / $num_classes) - (($graph_width / $num_classes) * 0.24); ?>px;
	margin: 0 <?php echo ($graph_width / $num_classes) * 0.12; ?>px;
	background: #f00;
	height: <?php echo $graph_height; ?>px;
...
<div id="container">
	...
	<?php
		foreach($classes as $class => $data) {
			echo '<div class="legend">'.$class.'</div>';
		}
	?>
	</div>
	<div class="clear"></div>
