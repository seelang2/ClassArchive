// JavaScript Document - demo_f1.js
...
function getResults() {
	...
	ajaxSendReq("GET", 'seriesdata.php?x='+x+'&mode=data&series=&model='+tempvar.options[tempvar.selectedIndex].value, handleResultsResp, null, 'XML');
}
