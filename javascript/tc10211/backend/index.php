 ...
 * Change Log
 * ----------
 * v0.3 - Implemented wrapvar wrapper option
...
@define('API_BASE_PATH', '/tc10211/backend/');
...
// outputs code
function output($data, $code = 200, $callback = '', $wrapper = '') {
...
$wrapvar = empty($_GET['wrapvar']) ? '' : $_GET['wrapvar'];
...
switch($_SERVER['REQUEST_METHOD']) {
	...
	case 'GET':
		...
		output($result, 200, $callback, $wrapvar);
