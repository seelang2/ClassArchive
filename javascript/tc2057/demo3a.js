...
var Lightbox = new function() {
	...
	this.buildGallery = function() {
		...
		lightboxDiv.onmouseover = function(e) {
			...
			Lightbox.timer = setTimeout(doLightbox, 1000);
			/*
			Lightbox.showLightbox(target.id);
			*/
		};
		
		lightboxDiv.onmouseout = function() {
			// clear any timer events if we move off an element
