...
define('API_BASE_PATH', '/tc8977/rolodex/api/');
...
$schema = array(
	'contacts' => array(
		'0' => array('firstname', 'lastname', 'email','gender','dob','address1','address2','city','state','zip','country'),
		'54ca8476c8538' => array(
			'firstname' => 'John',
			'lastname' => 'Doe',
