...
END;
	...
	case 'ADDFORM':
?>
<form action="<?php echo $me; ?>?mode=addrec" method="post">
	Contact Name: <input type="text" name="name" /><br  />
	Address: <input type="text" name="address" />
	<input type="submit" name="butSubmit" value="Add Contact"  />
</form>
<?php		
	break;
...
?>
<form action="<?php echo $me; ?>?mode=editrec&id=<?php echo $row['id']; ?>" method="post">
