...
<p>Contact ID: <input type="text" name="contact_id" value="<?php echo $row['contact_id']; ?>" /></p>
...
<?php
	...
	case 'LIST':
		$query = 'SELECT r.id, c.firstname, c.lastname, r.content FROM roompages AS r, contacts AS c WHERE r.contact_id = c.id';
