...
// sample to print page
echo '<a href="JavaScript:window.print();">Print this page</a>';
echo '<br /> <a href="#" onclick="window.print(); return false;">Print this page</a>';
...
<?php
	...
	if ($form_validated) {
		...
		// email a message to admin
		$subject = 'New User Registration Form';
		...
		$to = 'Chris <chris@sitebabble.com>';
		
		$headers = 'From: ' . $sender . "\r\n";
		
		$mail_sent = mail($to, $subject, $message, $headers);
		
		mail('chris@sitebabble.com', 'Test email', 'Testing', 'From: chris@langtiw.com');
