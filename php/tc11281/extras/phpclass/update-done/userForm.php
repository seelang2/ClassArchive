...
<h1>User Admin</h1>
  ...
  <h2>Contact Info</h2>
    <p>
        ...
        <input name="firstName" type="text" id="firstName" size="40" value="<?php echo $firstName; ?>">
    </p>
    <p>
    ...
    <p>
        What do you read?<br>
        <label><input name="publications[]" type="checkbox" id="publications_drf" value="Daily Racing Form" <?php if ( stristr($publications,'Daily Racing Form') ) { echo 'checked';} ?>> Daily Racing Form</label>
        <label><input name="publications[]" type="checkbox" id="publications_elle" value="Elle" <?php if ( stristr($publications,'Elle') ) { echo 'checked';} ?>> Elle</label>
    </p>
    <p>
